...
* Zhou, Q., Chai, B., Tang, C., Guo, Y., & **Ye, Y.**\* (2026). Latent Diffusion Neural Fields for zero-shot and uncertainty-aware bearing remaining useful life prediction. *Reliability Engineering & System Safety*, in press. (**SCI, JCR Q1, IF 13.7**)
